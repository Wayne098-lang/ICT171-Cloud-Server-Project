...
https://waynecloud.site/status.html

### Resource Centre

https://waynecloud.site/resources/

### Administrative Portal

https://waynecloud.site/admin.html
...
WayneCloud was developed as a multi-purpose cloud server hosted on Microsoft Azure.

The platform integrates several services into one cloud environment:

* Main website hosted using Nginx
...
These services are connected through a unified navigation structure, creating an integrated cloud platform rather than a standalone website.
...
2. Ubuntu Server installation and configuration
3. Nginx web server installation
4. Website deployment
5. DNS configuration and domain integration
